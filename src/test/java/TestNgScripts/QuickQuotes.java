...
//	}
	...
	public void VerfiySummaryPage() throws InterruptedException{     // Verify summary page 
		...
		NavigationMethods.driver.findElement(By.xpath("//*[@id='wm-shoutout-181645']/div[4]/div[2]/span[2]")).click();  // Walkme poup 
		NavigationMethods.driver.findElement(By.xpath("//*[@id='wm-shoutout-177578']/div[1]")).click();                 // Walkme poup 
...
//	 NavigationMethods.Scroll();
//	 Thread.sleep(3000);
//	 NavigationMethods.driver.findElement(By.name(Md_Element.qqLotName0)).sendKeys("Lorem Ipsum is simply dummy text of the printing and typesetting industry.Lorem Ipsum has been the industry's standard dummy text ever since the1500.");
...
//	 Thread.sleep(5000);
//	 NavigationMethods.driver.findElement(By.xpath(Md_Element.qqAddPart)).sendKeys("d1@mailinator.com");
//	                   // Valid Email
//	 WebElement textbox =
...
//	 NavigationMethods.driver.findElement(By.xpath(Md_Element.qqAddPart)).sendKeys("d1mailinator.com");
//	                    // Invalid Email
//	 WebElement textbox2 =
//	 NavigationMethods.driver.findElement(By.xpath(Md_Element.qqAddPart));
...
//	
//	 @Test (priority=18)
//	 public void VerifydleteContent (){
//	 NavigationMethods.driver.findElement(By.xpath(Md_Element.qqEditContent)).click();
//	 NavigationMethods.driver.findElement(By.xpath(Md_Element.qqDeltepop)).click();
//	 }
